...
// Query: *[_type == "category"] | order(name asc) // Fetch all categories Query data GROQ
...
// Query: *[_type == "product"] | order(name asc) // Fetch all products Query data GROQ
...
// Variable: PRODUCT_SERCH_QUERY
// Query: *[_type == 'product' && name match $queryParam] | order(name asc)
export type PRODUCT_SERCH_QUERYResult = Array<{
  _id: string;
  _type: "product";
  _createdAt: string;
  _updatedAt: string;
...
// Source: ./sanity/lib/products/searchProductsBySlug.ts
...
// Source: ./sanity/sales/getAllSalesByCouponCode.ts
// Variable: ACTIIVE_SALE_BY_COUPON_QUERY
// Query: *[_type == "sale"            && isActive == true            && couponCode == $couponCode            ] | order(validFrom desc) [0]
export type ACTIIVE_SALE_BY_COUPON_QUERYResult = {
  _id: string;
  _type: "sale";
  _createdAt: string;
  _updatedAt: string;
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "\n        *[_type == 'product' && name match $queryParam] | order(name asc)": PRODUCT_SERCH_QUERYResult;
    "\n        *[_type == 'product' && slug.current == $slug] | order(name asc) [0]": PRODUCT_BY_ID_QUERYResult;
    "\n        *[_type == \"sale\"\n            && isActive == true\n            && couponCode == $couponCode\n            ] | order(validFrom desc) [0]\n    ": ACTIIVE_SALE_BY_COUPON_QUERYResult;
  }
}
